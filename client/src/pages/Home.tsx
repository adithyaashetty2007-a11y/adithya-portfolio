    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] font-sans relative selection:bg-white/20 selection:text-white">
      ...
      {showIntro && (
        <div className="fixed inset-0 z-50 bg-[#0a0a0a] flex flex-col items-center justify-center transition-opacity duration-700">
            ...
            <h1 className="font-almie text-4xl sm:text-7xl font-extrabold text-[#ccff00] tracking-wider animate-pulse drop-shadow-[0_0_25px_rgba(204,255,0,0.6)] uppercase">
              ADITHYA A <span className="text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.6)]">SHETTY</span>
            </h1>
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="space-y-4 text-zinc-300 text-base sm:text-lg font-sans leading-relaxed max-w-2xl font-mono relative">
                ...
                <p className="text-zinc-200">
                  ...
                  <TerminalTypingText key={`t1-${typingKey}`} text="I AM A COMPUTER SCIENCE ENGINEERING STUDENT AT ST. JOSEPH ENGINEERING COLLEGE, MANGALURU, CURRENTLY STUDYING IN MY 2ND YEAR FROM SEPTEMBER 2026. I ENJOY TURNING IDEAS INTO PRACTICAL SOFTWARE SOLUTIONS AND CONTINUOUSLY IMPROVING MY TECHNICAL SKILLS." speed={8} delay={200} resetKey={typingKey} />
                </p>
